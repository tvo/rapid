...
project = u'rapid-spring'
copyright = u'2010, Tobi Vollebregt'
...
htmlhelp_basename = 'rapid-springdoc'
...
latex_documents = [
  ('index', 'rapid-spring.tex', u'rapid-spring Documentation',
   u'Tobi Vollebregt', 'manual'),
]
